...
class LidarLikeNet01(nn.Module):
    def __init__(self,input_dim,output_dim):
        super(LidarLikeNet01, self).__init__()
        # Adjust the input features of the first layer to match your dataset
        self.fc1 = nn.Linear(input_dim, 1024)  # Adjusted from 26 to 1083
