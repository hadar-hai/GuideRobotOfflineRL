...
scaler_path = r".\data_based_agents\models\scalers\scaler_better.pkl"
...
# all values in features that are greater than 267 are set to 1000
# features[features >= 267] = 1000
...
plt.ylabel('Loss')
plt.legend()
plt.savefig(r".\data_based_agents\plots\train_val_loss_lidarlike_better.png")
plt.close()
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig(r".\data_based_agents\plots\val_accuracy_lidarlike_better.png")
...
plt.savefig(r".\data_based_agents\plots\confusion_matrix_lidarlike_better.png")

# Save the scaler
joblib.dump(scaler, scaler_path)

#save the model 
torch.save(model.state_dict(), r".\data_based_agents\models\behavior_cloning_lidar_better.pth")
