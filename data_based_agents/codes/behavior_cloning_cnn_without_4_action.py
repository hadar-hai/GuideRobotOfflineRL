...
history_df.to_csv(model_dir + "\\behavior_cloning_cnn_100_not_moving_action_removed.csv")
...
with open(model_dir + "\\behavior_cloning_cnn_100_not_moving_action_removed.txt", "w") as f:
...
# Save the model
model.save(model_dir + "\\behavior_cloning_cnn_100_not_moving_action_removed.h5")