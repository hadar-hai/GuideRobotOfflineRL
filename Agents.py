...
class BehavioralCloning_LidarBased_WithGoal(Agent):
    ...
    def predict_action(self, state):
        ...
        # All beams:
        self.scaler_path = r".\data_based_agents\scalers\scaler_smallmap_pytorch_without_not_moving_with_goal.pkl"
        self.model_path = r".\data_based_agents\models\smallmap_behavior_cloning_lidar_pytorch_without_not_moving_with_goal.pth"
        # Less beams:
...
class BehavioralCloning_LidarLikeTF(Agent):
    ...
    def get_state_set_action(self, state=None):
        ...
        measurements = self.calculate_lidar_measurements(state)
        model = load_model(r'.\data_based_agents\models\\behavior_cloning_lidar_tf.h5', compile=False)
...
class BehavioralCloning_LidarBased(Agent):
    ...
    def predict_action(self, state):
        self.scaler_path = r".\data_based_agents\scalers\scaler_smallmap_pytorch_without_not_moving_with_goal_less_epochs.pkl"
        self.model_path = r".\data_based_agents\models\smallmap_behavior_cloning_lidar_pytorch_without_not_moving_with_goal_less_epochs.pth"
...
class BehavioralCloning_DistancesBasedAgent(Agent):
    ...
    def get_state_set_action(self, state=None):
        ...
        # Load the model
        if with_4_action:
            model = load_model(r'.\data_based_agents\models\\behavior_cloning_distances.h5', compile=False)
        else:
            model = load_model(r'.\data_based_agents\models\\behavior_cloning_distances_not_moving_action_removed.h5', compile=False)
...
class BehavioralCloning_ImagesBasedAgent(Agent):
    ...
    def get_state_set_action(self, state=None):
        ...
        # Load the model
        if with_4_action:
            model = load_model(r'.\data_based_agents\models\\behavior_cloning_cnn_100.h5', compile=False)
        else:
            model = load_model(r'.\data_based_agents\models\\behavior_cloning_cnn_100_not_moving_action_removed.h5', compile=False)
...
class EpsilonLeashFollow(Agent):
    ...
    def __init__(self, obstacles = None, goal = None):
        super().__init__(obstacles, goal)
        self.epsilon = 0.12
        self.no_of_steps = 5  # how many steps towards a taught leash
